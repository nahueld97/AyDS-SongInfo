...
class HomeViewActivity : Activity(), HomeView {
    ...
    override fun navigateToOtherDetails(artistName: String) {
        val intent = Intent(this, ayds.songinfo.moredetails.presentation.view.OtherInfoWindow::class.java)
        intent.putExtra(ayds.songinfo.moredetails.presentation.view.OtherInfoWindow.ARTIST_NAME_EXTRA, artistName)
